#!/usr/bin/python
# -*-coding:utf8-*-
# Django settings for student_performance_platform project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'student_performance_platform',  # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'student_performance_platform.urls'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'django_request_logfile': {
            'level': 'WARNING',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(PROJECT_DIR, 'logs/django_request_logfile.log'),
            # you need define your VAR_ROOT variable that points to your project path,and mkdir a logs directory in your project root path.
            'backupCount': 5,
            'maxBytes': '16777216',  # 16megabytes(16M)
        ...
        'django_db_backends_logfile': {
            'level': 'WARNING',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(PROJECT_DIR, 'logs/django_db_backends_logfile.log'),
            # you need define your VAR_ROOT variable that points to your project path,and mkdir a logs directory in your project root path.
            'backupCount': 5,
            'maxBytes': '16777216',  # 16megabytes(16M)
