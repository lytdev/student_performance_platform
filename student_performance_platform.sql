...
Source Server         : 192.168.193.129
Source Server Version : 50549
Source Host           : 192.168.193.129:3306
Source Database       : student_performance_platform

Target Server Type    : MYSQL
Target Server Version : 50549
File Encoding         : 65001

Date: 2016-06-06 20:12:47
*/
...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('1', 'admin1990', '', '', 'liuyuantao1990@gmail.com', 'sha1$29053$748c6e9a4b2899fd36fd2c099011570570bd5572', '1', '1', '1', '2016-05-15 19:40:30', '2012-12-10 05:55:42');
...
-- ----------------------------
INSERT INTO `captcha_captchastore` VALUES ('2', '9-5=', '4', 'd6bd6888aa0d057ad326021f52a31658ccdabbed', '2016-05-15 19:45:33');
...
CREATE TABLE `comperformancescore` (
  ...
  `comperformance_id` int(11) NOT NULL,
  `score` double DEFAULT NULL,
  `assessmentscore` double DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `django_session` VALUES ('870130c39f2293f779895f9d1c3b375d', 'ZGM2MzFjZDFiZGM2MWFkMjBmZGY1NjAyNmE2ZGZiZGZhNDIyMmYzODqAAn1xAS4=\n', '2016-05-29 19:40:33');
